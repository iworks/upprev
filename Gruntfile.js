...
module.exports = function(grunt) {
	...
	var excludeCopyFilesWPorg = excludeCopyFiles.slice(0).concat(
		[
			...
			'!includes/iworks/upprev/class-iworks-upprev-github.php',
			'!includes/pro/**',
			'!languages/*.mo',
			'!languages/*.po',
		]
	...
	var conf = {
		...
		js_files_concat: {
			'assets/scripts/admin.js': [
				'assets/scripts/src/admin/configuration.js',
			],
			'assets/scripts/upprev.js': [
				'assets/scripts/src/frontend/upprev.js',
			]
		},

		// SASS files to process. Resulting CSS files will be minified as well.
		css_files_compile: {
			'assets/styles/admin/configuration.css': 'assets/sass/admin/configuration.scss',
			'assets/styles/frontend/box.css': 'assets/sass/frontend/box.scss'
		},
		css_files_concat: {
